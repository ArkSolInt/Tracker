...
/// </summary>
public class MauiAuthenticationStateProvider(ILogger<MauiAuthenticationStateProvider> logger) : IAuthenticationService
{
    ...
    private Task<AuthenticationState> _currentAuthState = Task.FromResult(new AuthenticationState(_defaultUser));
